...
// sendmail2.php?printernaam=MK3&bestandsnaam=bestandje&imagenaam=Plaatje
...
function Meel($Onderwerp, $Aan, $HTML) {
 ...
 try {
  ...
  $mail->Port       = 465;
  $mail->setFrom('3D-printer@yourdomain.com', '3D Printer');
  $mail->addAddress($Aan);
...
$body = "
 ...
 <img src=cid:preview3dobject><br>
 Groetjes,<br>Je 3D-printer.
";
Meel("Printjob $printernaam voltooid","youremail@gmail.com",$body);
